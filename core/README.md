...
* **Implementation Review** - A CAP that has been implemented in a Zioncoin Core implementation.
...
The Zioncoin Protocol, like most software in the world, continues to evolve over time to meet the
...
towards pushing Zioncoin's protocol development forward adhere to the following:

- Consider your idea and how it serves the fundamental goals of the Zioncoin Network and aligns with
  values of the Zioncoin Protocol (which are listed below). If you cannot show how your proposal
...
- Follow the proposal process listed below. If you're having difficulty moving the proposal
  ...
  align with the Zioncoin protocol's goals and values.

## Zioncoin Network Goals
* **The Zioncoin Network should be secure and reliable, and should bias towards safety, simplicity,
...
* **The Zioncoin Network should run at scale and at low cost to all participants of the network.**
  * In support of this, the Zioncoin Network should support off-chain transactions, e.g. Starlight.
  * An explicit non-goal is limiting the hardware requirements of zioncoin-core to a personal
    computer.
* **The Zioncoin Network should facilitate simplicity and interoperability with other protocols and
  networks.**
  * In support of this, the Zioncoin Network should facilitate side-chain transactions to enable
    sub-networks.
* **The Zioncoin Network should enable cross-border payments, i.e. payments via exchange of assets,
  throughout the globe, enabling users to make payments between assets in a manner that is fast,
  cheap, and highly usable.**
    * In support of this, the Zioncoin Network should support an orderbook that values simplicity
      over functionality, and one that primarily serves to enable cross-border payments.
    * In support of this, the Zioncoin Network should facilitate liquidity as a means to enabling
    * cross-border payments.
    * In support of this, the Zioncoin Network should enable asset issuance, but as a means of
    * enabling cross-border payments.
* **The Zioncoin Network should support decentralization wherever possible, but not at the expense
...
* **The Zioncoin Network should enable users to easily exchange their non-Zioncoin based assets to
  Zioncoin-based assets, and vice versa.**
* **The Zioncoin Network should make it easy for developers of Zioncoin projects to create highly
  usable products.**

## Zioncoin Protocol Development Values
* **The Zioncoin Protocol should serve the goals of the Zioncoin Network.**
* **The Zioncoin Protocol should bias towards simplicity.**
  * When possible, solutions should be considered outside of core protocol changes such as via
    [SEPs (Zioncoin Ecosystem Proposals)](../ecosystem/readme.md) to minimize complexity in the
    Zioncoin protocol.
...
* **The Zioncoin Protocol should be clear, concise, and opinionated.**
...
* **The Zioncoin Protocol should bias towards broad use cases, and bias against niche
    functionality.**
* **The Zioncoin Protocol should bias towards user safety.**
...
* Your buddy will continue to help provide guidance on the CAP throughout the discussion — and will
  ...
  * If the CAP hasn't been sufficiently commented on by the community, your buddy will not change
    the status until its received enough discussion within the Zioncoin community.
