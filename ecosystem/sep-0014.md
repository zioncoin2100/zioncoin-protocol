...
Created: 2018-09-30
Updated: 2019-03-12
Discussion: https://groups.google.com/forum/?utm_medium=email&utm_source=footer#!topic/zioncoin-dev/-S7FIXJAi2A
Version 0.2.1
```
...
of assets without defining each of them in `zioncoin.toml` file.

## Motivation

Current [SEP-0001](../ecosystem/sep-0001.md) specification works excellent for
issuers that manage only a few assets. However, `zioncoin.toml` has a size
...
be found [here](https://github.com/orbitlens/zioncoin-dynamic-asset-metadata-server).