...
The Anchor would add DEPOSIT_SERVER to zioncoin.toml file
------
Add a DEPOSIT_SERVER section to your zioncoin.toml file that tells the wallet the URL of your deposit server endpoint.
...
------
The deposit URL specified in your zioncoin.toml file should accept an HTTP GET request and issue responses of the form detailed below.
...
`?address=<zioncoin address>&asset=asset_name`
...
```
{
  "zioncoin_address": <wallet provided>,
  "asset": <asset_name>
...
```
{
  "zioncoin_address": "GD6WU64OEP5C4LRBH6NK3MHYIA2ADN6K6II6EXPNVUR3ERBXT4AN4ACD",
  "asset": "BTC",
...
```
{
  "zioncoin_address": "GD6WU64OEP5C4LRBH6NK3MHYIA2ADN6K6II6EXPNVUR3ERBXT4ABLAH",
  "asset": "EURT",
